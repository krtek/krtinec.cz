...
což je jednoduchý způsob, jak spustit konkrétní aplikaci.
...
(`chrome.storage.sync`) sdílí mezi všemi počítači konkrétního uživatele.
...
1. Aplikace se "zabalí" pomocí "Pack extension" přímo v prohlížeči
   Chrome. Tento krok je nutný _pouze_ pro distribuci aplikace mimo
...
A běží i na mobilu? No jéje! Ale o tom až příště.
