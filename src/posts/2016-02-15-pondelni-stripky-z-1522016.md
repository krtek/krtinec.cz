...
Takže bratia a sestry (Deniska\!), žádné výmluvy, pořiďte si _Hlasovací
preukazy_ a pošlete Fica do důchodu.
...
jakžtakž použitelnou _lazy load_ knihovnu pro Angular.

## Webpack

No a když už jsme se bavili o _lazy loadingu_ a balíčkování, ukázal nám
...
[Babel](https://babeljs.io/docs/learn-es2015/), který zdrojáky v _novém_
Javascriptu přeloží do _starého_ Javascriptu, aby fungovaly i ve starší
browserech.

Takže bez výmluv: _Nové_ projekty v _novém_ roce už jen v _novém_
Javascriptu\!
